...
export const FOOTER_COLUMNS: { heading: string; links: NavItem[] }[] = [
  {
    ...
    links: [
      ...
      { label: 'kotoshu gem (Ruby)', href: 'https://github.com/kotoshu/kotoshu' },
      { label: 'kotoshu-rs (Rust engine)', href: 'https://github.com/kotoshu/kotoshu-rs' },
      { label: 'kotoshu-js (JS + wasm)', href: 'https://github.com/kotoshu/kotoshu-js' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'npm', href: 'https://www.npmjs.com/org/kotoshu' },
      { label: 'PyPI', href: 'https://pypi.org/project/kotoshu/' },
      { label: 'crates.io', href: 'https://crates.io/crates/kotoshu' },
